...
const sidebarVariants = cva(
  "group/sidebar relative flex h-full w-[--sidebar-width] flex-col border-r border-sidebar-border bg-sidebar text-sidebar-foreground transition-[width] duration-200 ease-linear",
  {
    variants: {
      variant: {
  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            sidebarVariants({ side, variant, collapsible: state === "collapsed" ? collapsible : "offcanvas" }),
            className
          )}
          {...props}
        >
