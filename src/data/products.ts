...
export const newArrivalProducts: Product[] = [
  ...
  },
  {
    ...
    price: 95,
    brand: 'LuxeFashion',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRe6ItaC8qKn3M3rZCRSpfcDz4boFmAE_ftXA&s',
    category: 'women',
    rating: 4.7,
    reviews: 32,
...
export const getProductsByCategory = (category: string) => {
  ...
  if (category === 'new-arrivals') return newArrivalProducts;
  
  // For specific categories, get normal + sale + new products for that category
